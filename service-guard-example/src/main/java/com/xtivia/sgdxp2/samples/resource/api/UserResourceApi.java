...
public interface UserResourceApi {
	...
	@OmniAdmin
	@Authorized
	Response getAllUsers(@Context SecurityContext securityContext, @Context HttpServletRequest servletRequest,
	...
	@OmniAdmin
	@Authorized
	Response getUser(@PathParam("userId") long userId, @Context SecurityContext securityContext,
			@Context HttpServletRequest servletRequest, @Context ServiceContext serviceContext, @Context User user);
}
